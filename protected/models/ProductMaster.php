...
class ProductMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('supplierId, brandId, brandModelId, categoryId, model, sku, upc, location, quantity, productUnits, stockStatusId, price, priceGroupId, taxClassId, dateAvailable, length, width, height, dimensionUnits, metricUnits, updateDateTime, marginId', 'required'),
