...
class BankMaster extends MasterCActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'bankNameId, branch, accNo, accName, accType, supplierId, status',
                'required'
            ),
            array(
                'status',
            ...
            array(
                'id, bankNameId, branch, accNo, accName, accType, supplierId, compCode, status, createDateTime, searchText',
                'safe',
                'on' => 'search'
            ),
        );
