...
class AddressMaster extends MasterCActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'userId, address_1, address_2, districtId, amphurId, provinceId, countryId, postcode, type',
                'required'
            ),
            array(
                'type',
            ...
            array(
                'districtId, amphurId, provinceId',
                'length',
                'max' => 5
            ),
            array(
            ...
            array(
                'addressId, userId, firstname, lastname, company, address_1, address_2, districtId, amphurId, provinceId, countryId, postcode, type, latitude, longitude, taxNo, searchText',
                'safe',
                'on' => 'search'
            ),
        );
