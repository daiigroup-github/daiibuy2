...
class BankNameMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, logo, createDateTime, updateDateTime', 'required'),
			...
			array('bankNameId, title, description, logo, status, createDateTime, updateDateTime, searchText', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'banks' => array(self::HAS_MANY, 'Bank', 'bankNameId'),
		);
	}
