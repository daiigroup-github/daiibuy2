...
class UserMaster extends MasterCActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'status, approved, token, type',
                'required'
            ),
            array(
                'newsletter, status, approved, type, isFirstLogin, collectedPoint, collectedOrder',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'cart, wishlist, description, logo, createDateTime, map',
                'safe'
            ),
            array(
                'createDateTime',
            ...
            array(
                'userId, firstname, lastname, email, telephone, fax, password, cart, wishlist, newsletter, ip, status, approved, token, type, isFirstLogin, description, logo, createDateTime, map, minimumOrder, referenceId, collectedPoint, collectedOrder, redirectURL, taxNumber, searchText',
                'safe',
                'on' => 'search'
            ),
        );
