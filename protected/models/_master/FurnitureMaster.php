...
// will receive user inputs.
        return array(
            array(
                'furnitureGroupId, title, createDateTime, updateDateTime',
                'required'),
            array(
                'status',
                'numerical',
...
// @todo Please remove those attributes that should not be searched.
            array(
                'furnitureId, furnitureGroupId, title, description, image, status, createDateTime, updateDateTime',
                'safe',
                'on' => 'search'),
        );
    }
...
// @todo Please modify the following code to remove attributes that should not be searched.
        ...
        $criteria->compare('furnitureGroupId', $this->furnitureGroupId, false);
    ...
    public function beforeDelete()
    {
        ...
        $suppliers = SupplierVehices::model()->findAll();
        foreach ($suppliers as $id => $item)
        {
            $vehicles = explode('|', $item->supplier_vehicles);
            if (in_array($this->id, array_values($vehicles)))
            {

            }

// throw CDbException here
        }
