...
class OrderDetailMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('orderDetailTemplateId, orderId', 'required'),
			array('orderDetailTemplateId, orderId', 'length', 'max'=>20),
			...
			array('orderDetailId, orderDetailTemplateId, orderId, createDateTime, updateDateTime, searchText', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'orderDetailValues' => array(self::HAS_MANY, 'OrderDetailValue', 'orderDetailId'),
		);
	}
