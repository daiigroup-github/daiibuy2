...
class ProductImageMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('productId, image, createDateTime, updateDateTime', 'required'),
			...
			array('productImageId, productId, title, description, image, sortOrder, status, createDateTime, updateDateTime, searchText', 'safe', 'on'=>'search'),
		);
	}
