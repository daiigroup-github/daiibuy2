...
class OrderGroupHistoryMaster extends MasterCActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'orderGroupId, decision, description, reasonCode, createDateTime',
                'required'),
            array(
                'orderGroupHistoryId, orderGroupId',
                'length',
                'max' => 20),
            array(
                'decision, reasonCode',
            ...
            array(
                ...
                'max' => 200),
            array(
                'orderGroupHistoryId, updateDateTime',
                'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array(
                'orderGroupHistoryId, orderGroupId, decision, description, reasonCode, createDateTime, updateDateTime',
                'safe',
                'on' => 'search'),
        );
    }
