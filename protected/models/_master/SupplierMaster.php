...
class SupplierMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, companyName, companyNameEng, email', 'length', 'max'=>200),
			...
			array('supplierId, name, prefix, description, companyName, companyNameEng, address1, address2, districtId, amphurId, provinceId, postcode, taxNumber, email, tel, fax, logo, logoDoc, url, minimumOrder, status, createDateTime, updateDateTime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'companyNameEng' => 'Company Name Eng',
			'address1' => 'Address1',
			'address2' => 'Address2',
			'districtId' => 'District',
			'amphurId' => 'Amphur',
	...
	public function search() {
        ...
        $criteria->compare('companyNameEng', $this->companyNameEng, true, 'OR');
