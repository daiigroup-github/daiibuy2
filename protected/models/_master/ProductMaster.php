...
class ProductMaster extends MasterCActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array(
                'supplierId, code, quantity, productUnits, price, priceGroupId, dateAvailable, length, width, height, dimensionUnits, metricUnits, updateDateTime',
                'required'),
            array(
                'quantity, stockStatusId, shipping, noPerBox, subtract, sortOrder, status',
                'numerical',
                'integerOnly' => true),
            array(
                'supplierId, brandId, brandModelId, categoryId, categoryId2, code, isbn, taxClassId, marginId',
                'length',
                'max' => 20),
            array(
                'name',
            ...
            array(
                ...
                'max' => 255),
            array(
                'price, otherPrice, weight, length, width, height, area',
                'length',
                'max' => 15),
            array(
                'priceGroupId',
    ...
    public function attributeLabels() {
        return array(
            ...
            'shipping' => 'Shipping',
            'price' => 'Price',
            'otherPrice' => 'ราคาเจ้าอื่น',
            'noPerBox' => 'จำนวนต่อกล่อง',
    ...
    public function search() {
        ...
        $criteria->compare('LOWER(otherPrice)', strtolower($this->searchText), true, 'OR');
