...
class SupplierSpacialProject extends SupplierSpacialProjectMaster
{
	...
	public function findAllSpacialArray()
	{
		$result = array();
		if(Yii::app()->user->userType == 3)
		{
			$items = $this->findAll("supplierId =" . Yii::app()->user->supplierId);
		}
		...
		{
			$result[$item->supplierSpacialProjectId] = $item->code . " - " . $item->percent . "%";
		}
		return $result;
	}
