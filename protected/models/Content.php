...
class Content extends ContentMaster {
    ...
    public function showConfirmationContentBySupplierId($supplierId) {
        $supplierContentGroupModel = SupplierContentGroup::model()->find('status = 2');
        $res = isset($supplierContentGroupModel->supplierContents[0]) ? $supplierContentGroupModel->supplierContents[0] : "1.กำหนดส่งสินค้าภายใน 15 วันหลังจากได้รับการชำระค่าสิน้ค้าแล้ว<br> 2.ราคาสินค้ารวมภาษีมูลค่าเพิ่มและค่าขนส่งแล้ว<br> 3.สินค้าที่ส่งเข้าหน่วยงานแล้วทางบริษัทฯ จะไม่รับคืน <br> 4.มูลค่าขั้นต่ำที่สามารถสั่งซื้อผ่านระบบ Online ได้ คือ 20,000 บาท<br>5.ราคาสินค้า ซื้อ-ขายเป็นไปตามหน้า Website ในขณะที่ทำการสั่งซื้อเท่านั้น อาจมีการเปลี่ยนแปลงโดยมิต้องแจ้งล่วงหน้า.";
