        ...
        <div class="page-content">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <p>
                        <?php echo CHtml::radioButton('billingRadio', false, array('id'=>'billingRadio', 'value'=>1));?>
                        <label class="radio-label" for="billingRadio">เลือก</label>
                    </p>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo CHtml::dropDownList('existingBillingAddress', '', $shippingAddressModel->getAllAddressByType(Address::ADDRESS_TYPE_BILLING), array('class'=>'chosen-select-full-width', 'prompt'=>'--- Select ---')); ?>
                </div>
            </div>
            <hr />
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <p>
                        <?php echo CHtml::radioButton('billingRadio', false, array('id'=>'newBillingRadio', 'value'=>2));?>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'lastname', array('id'=>'billingLastName', 'name'=>'billing[lastname]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'company', array('id'=>'billingCompany', 'name'=>'billing[company]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'address_1', array('id'=>'billingAddress1', 'name'=>'billing[address_1]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'address_2', array('id'=>'billingAddress2', 'name'=>'billing[address_2]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php
                    echo $form->dropDownList($billingAddressModel, 'provinceId',
                        CHtml::listData(Province::model()->findAll(array('order'=>'provinceName')), 'provinceId', 'provinceName'),
                        array(
...
//                            'class'=>'chosen-select-full-width',
                            ...
                            'ajax'=>array(
                                'type'=>'POST',
                                'data'=>array('amphurId'=>'js:this.value'),
...
//                            'class'=>'chosen-select-full-width',
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'postcode', array('id'=>'billingPostcode', 'name'=>'billing[postcode]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($billingAddressModel, 'taxNo', array('id'=>'billingTaxNo', 'name'=>'billing[taxNo]')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 register-account">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <p>
                        <?php echo CHtml::radioButton('shippingRadio', false, array('id'=>'shippingRadio', 'value'=>1));?>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <p>
                        <?php echo CHtml::radioButton('shippingRadio', false, array('id'=>'newShippingRadio', 'value'=>2));?>
                        <label class="radio-label" for="newShippingRadio">ที่อยู่ใหม่</label>
                    </p>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo CHtml::checkBox('sameAddress', false, array('id'=>'sameAddress'));?>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'lastname', array('id'=>'shippingLastName', 'name'=>'shipping[lastname]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'company', array('id'=>'shippingCompany', 'name'=>'shipping[company]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'address_1', array('id'=>'shippingAddress1', 'name'=>'shipping[address_1]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'address_2', array('id'=>'shippingAddress2', 'name'=>'shipping[address_2]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php
                    echo $form->dropDownList($shippingAddressModel, 'provinceId',
                        CHtml::listData(Province::model()->findAll(array('order'=>'provinceName')), 'provinceId', 'provinceName'),
                        array(
//                            'class'=>'chosen-select-full-width',
                            'id'=>'shippingProvince',
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php
                    echo $form->dropDownList($shippingAddressModel, 'amphurId',
                        array(),
                        array(
//                            'class'=>'chosen-select-full-width',
                            'id'=>'shippingAmphur',
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php
                    echo $form->dropDownList($shippingAddressModel, 'districtId',
                        array(),
                        array(
//                            'class'=>'chosen-select-full-width',
                            'id'=>'shippingDistrict',
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'postcode', array('id'=>'shippingPostcode', 'name'=>'shipping[postcode]')); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <?php echo $form->textField($shippingAddressModel, 'taxNo', array('id'=>'shippingTaxNo', 'name'=>'shipping[taxNo]')); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="page-content">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <?php echo CHtml::link('&lt; Back', '', array('class'=>'button orange', 'name'=>'Back'));?>
            <?php echo CHtml::submitButton('Next >', array('class'=>'big green pull-right', 'name'=>'Next'));?>
        </div>
    </div>
</div>
<?php $this->endWidget(); ?>
