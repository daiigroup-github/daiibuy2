<div class="row sidebar-box green">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="sidebar-box-heading">
            ...
            <h4><?php echo ($order->type == 1) ? 'Other' : $order->title; ?></h4>
        </div>
        <?php
            ...
            <table class="orderinfo-table table-bordered">
                ...
                <?php foreach ($order->orderItems as $orderItem): ?>
                    <tr>
                        ...
                        <td class="align-right" id="qty<?php echo $orderItem->productId;?>">
                            <?php if (($order->type & 1) > 0): /*myfile*/ ?>
                        ...
                        <td class="align-right" id="pricd<?php echo $orderItem->orderItemsId;?>"><?php echo number_format($orderItem->price, 2); ?></td>
                        <td class="align-right" id="total<?php echo $orderItem->orderItemsIdd;?>"><?php echo number_format($orderItem->quantity * $orderItem->price, 2); ?></td>
                    </tr>
