...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'furnitureItemId'); ?>
		<?php echo $form->textField($model,'furnitureItemId',array('size'=>20,'maxlength'=>20, 'class'=>'')); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'furnitureId'); ?>
		<?php echo $form->textField($model,'furnitureId',array('size'=>20,'maxlength'=>20, 'class'=>'')); ?>
	</div>
