...
<div class="form">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model, 'furnitureId', array(
			'class'=>'col-sm-2 control-label'));
		?>
		<div class="col-sm-10">
<?php echo $model->furniture->title; ?>
<?php echo $form->error($model, 'furnitureId'); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php if($this->action->id == 'update')
				echo CHtml::image(Yii::app()->baseUrl . $model->plan, '', array(
					'style'=>'width:150px;'));
			?>
<?php echo $form->fileField($model, 'plan', array(
	'class'=>'form-control'));
?>
