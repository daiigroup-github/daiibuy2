...
<div class="form">
	...
	<div class="form-group">
		<?php
		echo $form->labelEx($model, 'supplierContentGroupId', array(
			'class'=>'col-sm-2 control-label'));
		?>
		<div class="col-sm-10">
			<?php echo $model->supplierContentGroup->title; ?>
			<?php echo $form->error($model, 'supplierContentGroupId'); ?>
		</div>
	</div>
	<div class="form-group">
		<?php
