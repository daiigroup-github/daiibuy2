...
/* @var $data SupplierContent */
?>

<div class="alert alert-info">

	<b><?php echo CHtml::encode($data->getAttributeLabel('supplierContentId')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->supplierContentId), array('view', 'id'=>$data->supplierContentId)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('supplierContentGroupId')); ?>:</b>
	<?php echo CHtml::encode($data->supplierContentGroupId); ?>
	<br />
