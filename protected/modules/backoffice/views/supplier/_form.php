...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php echo $form->textArea($model,'address2',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php echo $form->textField($model,'tel',array('size'=>25,'maxlength'=>25, 'class'=>'form-control')); ?>
