...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="control-group">
			<?php echo $form->labelEx($model,'orderDetailTemplateId', array('class'=>'control-label')); ?>
		<div class='controls'>
			<?php echo $form->textField($model,'orderDetailTemplateId',array('class'=>'input-block-level')); ?>
