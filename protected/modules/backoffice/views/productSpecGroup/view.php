...
$this->menu = array(
	...
	array(
		...
		'url'=>array(
			'create')),
	array(
		'label'=>'Update ProductSpecGroup',
		'url'=>array(
			'update',
			'id'=>$model->productSpecGroupId)),
	array(
		'label'=>'Delete ProductSpecGroup',
		'url'=>'#',
		'linkOptions'=>array(
			'submit'=>array(
				'delete',
...
<div class="panel panel-default">
	<div class="panel-heading">
		View ProductSpecGroup #<?php echo $model->productSpecGroupId; ?>		<div class="pull-right">
			<?php
			echo CHtml::link('<i class="fa fa-backward"></i> Back', "", array(
