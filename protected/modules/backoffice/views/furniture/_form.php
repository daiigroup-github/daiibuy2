...
<div class="form">
	...
	<?php echo $form->errorSummary($model, '', '', array('class'=>'alert alert-danger')); ?>
			...
			<?php echo $form->labelEx($model,'furnitureGroupId', array('class'=>'col-sm-2 control-label')); ?>
			<div class="col-sm-10">
													<?php echo $form->textField($model,'furnitureGroupId',array('size'=>20,'maxlength'=>20, 'class'=>'form-control')); ?>
								<?php echo $form->error($model,'furnitureGroupId'); ?>
			</div>
		</div>
				<div class="form-group">
