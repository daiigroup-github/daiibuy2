...
//				'class'=>'btn btn-xs btn-primary'));
    ...
    <ul class="nav nav-tabs">
        <?php foreach ($suppliers as $supplier): ?>
            <li class="<?= ($supplier->supplierId == $supplierId) ? "active" : ""; ?>"><a  href="<?= Yii::app()->createUrl("backoffice/order/orderHistory?supplierId=" . $supplier->supplierId); ?>"><?= $supplier->name; ?></a></li>
        <?php endforeach; ?>
    </ul>
