...
//									}
            ...
            if (!($model->status == 1 || $model->status == 2 || $model->status == 3 || $model->status == 99 ) || ($model->status == 3 && (Yii::app()->user->userType == 3 || Yii::app()->user->userType == 7 ) && Yii::app()->controller->action->id == "print")) {
                if (isset(Yii::app()->user->id)) {
