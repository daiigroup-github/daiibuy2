...
/* @var $data ProductOptionGroup */
?>

<div class="alert alert-info">

	<b><?php echo CHtml::encode($data->getAttributeLabel('productOptionGroupId')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->productOptionGroupId), array('view', 'id'=>$data->productOptionGroupId)); ?>
	<br />
