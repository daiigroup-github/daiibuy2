...
class CategoryToSubController extends MasterBackofficeController {
    ...
    public function actionDelete($id) {
        $categoryId = CategoryToSub::model()->find('id=' . $id);
        Category::model()->deleteAll('categoryId=' . $categoryId->subCategoryId);
        CategoryStakeProvince::model()->deleteAll('categoryId=' . $categoryId->subCategoryId);
        CategoryToSub::model()->deleteAll('categoryId=' . $categoryId->subCategoryId);
        $this->loadModel($id)->delete();
        //throw new Exception($categoryId->categoryId);
        //Category::model()->deleteAll('categoryId=' . $id);
