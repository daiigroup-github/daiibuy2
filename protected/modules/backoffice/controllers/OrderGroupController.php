...
class OrderGroupController extends MasterBackofficeController
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['OrderGroup']))
		{
			...
			try
			{
				$model->attributes = $_POST['OrderGroup'];
	...
	{
		$dataProvider = new CActiveDataProvider('OrderGroup');
	 ...
	 * @param OrderGroup $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'order-group-form')
		{
