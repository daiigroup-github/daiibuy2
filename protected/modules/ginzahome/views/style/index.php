    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                foreach ($styles as $style):
                    ...
                    <li role="presentation" class="<?php echo ($i==0) ? 'active' : '';?>">
                        <a href="#style_<?php echo $style->id;?>" aria-controls="style_<?php echo $style->id;?>" role="tab" data-toggle="tab">style_<?php echo $style->category->title;?></a>
                    </li>
                    <?php
                    $i++;
                endforeach;
            ...
            <div class="tab-content">
                ...
                ?>
                <div role="tabpanel" class="tab-pane <?php echo ($i==0) ? 'active' : '';?>" id="style_<?php echo $style->id;?>">
                    <div class="row">
