...
//							'style'=>'width:150px')) : "", $this->createUrl('category/index?id=' . $model->category2Id . (isset($category1Id) ? "&category1Id=" . $model->category1Id : "")));
				echo isset($model->product->productImages[0]) ? CHtml::image(Yii::app()->createUrl($model->product->productImages[0]->image), $model->product->name, array(
						'style'=>'width:150px')) : "";
				?>
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5 product-content no-padding" style="height: 290px;">
				<div class="product-info">
					<h5><?php echo $model->product->name; ?></h5>
					<p><?php echo $model->product->description; ?></p>
				</div>
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2 red" style="font-size: large">
