    ...
    <div class="col-md-12">
        <ul class="nav nav-pills" role="tablist">
            <li class="active orange">
                <a href="<?php echo Yii::app()->request->baseUrl . "/index.php/myfile/ginzaTown/"; ?>"><h5>
                        ไฟล์ของฉัน</h5></a></li>
            <?php
            if (1 == 0):
// if($this->action->id == "view" && (!isset($model->fur[0]) || $model->fur[0]->status < 3)):
                ...
                <li class="active green">
                    <a href="<?php echo Yii::app()->request->baseUrl . "/index.php/myfile/ginzaTome/furniture/id/" . $_GET["id"]; ?>">
                        <h5>สั่งซื้อ Furniture</h5></a></li>
            <?php endif; ?>
