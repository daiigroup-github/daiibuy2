                    ...
                    <div class="col-md-12" id="upload_plan">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 3 : <input name="OrderFile[5]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 4 : <input name="OrderFile[6]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 5 : <input name="OrderFile[7]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 6 : <input name="OrderFile[8]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 7 : <input name="OrderFile[9]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 8 : <input name="OrderFile[10]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 9 : <input name="OrderFile[11]" type="file" class="file" data-show-upload="false">
                                </div>
                                <div class="form-group">
                                    แบบขยายประตู-หน้าต่าง 10 : <input name="OrderFile[12]" type="file" class="file" data-show-upload="false">
                                </div>
...
//                                            'onchange' => 'findType(this)'));
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td><button id="deleteRow" class="btn btn-danger">ลบรายการ</button></td>
                                </tr>
                                <tr>
                                    <td>2</td>
<!--                                    <td class="cat"><?php
...
//										'id'=>'"size"',
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <button id="deleteRow" class="btn btn-danger">ลบรายการ</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
...
//										'id'=>'type',
                                    ...
                                    <td class="size"><?php
                                        // echo CHtml::dropDownList('Criteria[0][size]', "size", $sizeDropDownArray);
                                        echo CHtml::dropDownList('Criteria[2][size]', "size", array(), array(
                                            'prompt' => 'เลือกขนาด',
                                            'class' => 'form-control',
//										'id'=>'"size"',
                                        ));
                                        ?></td>
                                    <td><?php
                                        echo CHtml::textField('Criteria[2][quantity]', 1, array(
                                            'class' => 'edit-table-qty-input'));
                                        ?></td>
                                    <td>
                                        <button id="deleteRow" class="btn btn-danger">ลบรายการ</button>
...
//										'id'=>'type',
                                    ...
                                    <td class="size"><?php
                                        // echo CHtml::dropDownList('Criteria[0][size]', "size", $sizeDropDownArray);
                                        echo CHtml::dropDownList('Criteria[3][size]', "size", array(), array(
                                            'prompt' => 'เลือกขนาด',
                                            'class' => 'form-control',
//										'id'=>'"size"',
                                        ));
                                        ?></td>
                                    <td><?php
                                        echo CHtml::textField('Criteria[3][quantity]', 1, array(
                                            'class' => 'edit-table-qty-input'));
                                        ?></td>
                                    <td>
                                        <button id="deleteRow" class="btn btn-danger">ลบรายการ</button>
        ...
        <!--			<tr>
                ...
                <div class="row">
                    ...
                    <?php
                    echo CHtml::link('<i class="icons fa fa-plus"></i>เพิ่มสินค้า', "#", array(
