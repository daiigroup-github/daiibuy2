 ...
 */
		...
		(function() {
			...
			for (var f = 0; f < e.length; f++)
				d[e[f]] = [{type: c, name: e[f]}, {type: b, name: e[f]}];
				...
				return{title: j.lang.flash.title, minWidth: 420, minHeight: 310, onShow: function() {
						...
						if (o) {
							...
							for (var t = 0, u = s.count(); t < u; t++)
								q[s.getItem(t).getAttribute('name')] = s.getItem(t);
						}
						var v = {}, w = {};
						y.commitContent(o, p, q, v, w);
						...
						if (this.preview)
							this.preview.setHtml('');
														...
														var o = this.getDialog(), p = function(q) {
															...
															o.preview.setHtml('<embed height="100%" width="100%" src="' + CKEDITOR.tools.htmlEncode(m.getAttribute('src')) + '" type="application/x-shockwave-flash"></embed>');
														};
