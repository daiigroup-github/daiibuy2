 ...
 */
		...
		(function() {
			var a = /\[\[[^\]]+\]\]/g;
			CKEDITOR.plugins.add('placeholder', {requires: ['dialog'], lang: ['bg', 'cs', 'cy', 'da', 'de', 'el', 'en', 'eo', 'et', 'fa', 'fi', 'fr', 'he', 'hr', 'it', 'nb', 'nl', 'no', 'pl', 'pt-br', 'tr', 'ug', 'uk', 'vi', 'zh-cn'], init: function(b) {
...
CKEDITOR.plugins.placeholder = {createPlaceholder: function(a, b, c, d) {
