<html>
	...
	<body>
		...
		<p> <b>การดำเนินการสั่งสื่อสินค้าเสร็จสมบูรณ์!!</b></p>
		<p>กรุณาตรวจสอบเลขที่สั่งซื้อด้านล่าง</p>

		<p>เลขที่สั่งซื้อสินค้า(Order No.) : <b><?php echo $invoiceNo; ?></b></p>

		<p><b>กรุณากด</b> <a href="<?php echo $documentUrl . $orderID ?>"><?php echo ">>View<<" ?></a> เพื่อตรวจสอบความถูกต้องที่หน้าเว็บไซต์</p>
