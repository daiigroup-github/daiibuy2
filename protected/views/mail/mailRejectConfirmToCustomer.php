<html>
	...
	<body>
		...
		<p> <b>การยืนยันข้อมูลการโอนเงินของคุณถูกตีกลับ!!</b></p>
		<p>กรุณาตรวจสอบข้อมูลด้านล่าง</p>

		<p>เลขที่สั่งซื้อสินค้า(Order No.) : <b><?php echo $invoiceNo; ?></b></p>
		<p>สถานะ : <b>หลักฐานการโอนเงินไม่ผ่านการตรวจสอบ</b></p>
		<p>เนื่องจาก : <b style="color: red;"><?php echo isset($remark) ? $remark : "-"; ?></b></p>
