<html>
	...
	<body>
		...
		<p>เรียน คุณ <b><?php echo $customerName; ?></b></p>

		<p> <b>ลูกค้าทำการสั่งสินค้าเสร็จสมบูรณ์</b></p>
		<p>กรุณาตรวจสอบเลขที่สั่งซื้อด้านล่าง</p>

		<p>ชื่อลูกค้า : <b><?php echo $customerName; ?></b></p>
		<p>เลขที่สั่งซื้อสินค้า(Order No.) : <b><?php echo $invoiceNo; ?></b></p>

		<p><b>กรุณากด</b> <a href="<?php echo $documentUrl; ?>"> >>View<< </a> เพื่อตรวจสอบรายการสินค้าที่สั่งซื้อในหน้าเว็บไซต์</p>
