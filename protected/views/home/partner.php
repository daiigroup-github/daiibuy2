<div class="row">
    <div class="col-lg-12">
        <h2>การสั่งซื้อสินค้าจากการแนะนำของ <?php echo ($partnerType == 1) ? "ORG" : "daiiwow.com"; ?></h2>
    </div>
</div>
<div class="row">
    <?php if (isset($promotions) && count($promotions) > 0): ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            echo $form->textField($user, 'telephone', array(
                                                'class' => 'form-control',
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            echo $form->textField($user, 'fax', array(
                                                'class' => 'form-control',
                                                'placeholder' => 'Fax ถ้าไม่มีให้ใส่ "-"'));
                                            ?>
            ...
            <?php if (Yii::app()->user->isGuest): ?>
                <div class="row sidebar-box blue">
                    <div class="col-lg-12">
                        ...
                        <div class="sidebar-box-heading" style="">
                            <i class="fa fa-file"></i>
                            <h4>ลงทะเบียน</h4>
                        </div>
