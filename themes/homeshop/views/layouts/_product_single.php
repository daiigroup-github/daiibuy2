		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 product-single-image">
				...
				<div id="product-slider">
					<ul class="slides">
						<li>
							<img class="cloud-zoom" src="<?php echo $product['images'][0];?>" data-large="<?php echo $product['images'][0];?>" alt="" />
				...
				*/
				...
				<table>
					...
					<tr>
						<td>จำนวนคงเหลือ</td>
						<td>
							<span class="<?php echo (isset($product['stock']) && $product['stock'] > 0) ? 'green' : 'red';?>"><?php echo (isset($product['stock']) && $product['stock'] > 0) ? 'In stock '. $product['stock'] : 'Out of stock';?></span>
						</td>
					</tr>
				</table>
